...
[Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=98&annotation=RARIK79X)“Animetism is an important visual paradigm to understand video games for two converging reasons: the importance of materials, and the composite nature of the image.” ([Arsenault et al., 2015, p. 98](zotero://select/library/items/AQQ93PWV))
...
### [Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=100&annotation=undefined)“Art History and Technical Drawing, from Perspective to Parallel Projection” ([Arsenault et al., 2015, p. 100](zotero://select/library/items/AQQ93PWV))
...
-   visual choices are deliberate and correlate with different types of gameplay: [Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=100&annotation=4D82ZP3Z)“parallel projection calls for a managerial relationship with space” ([Arsenault et al., 2015, p. 100](zotero://select/library/items/AQQ93PWV))

Now, video games can employ several of this approaches in [Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=101&annotation=undefined)“hybrid visuo-spatial configurations” ([Arsenault et al., 2015, p. 101](zotero://select/library/items/AQQ93PWV)). Games exploring non-euclidiean spaces are referred to as XD games by the authors.

## The Game FAVR

The authors point out once again, that they have a focus on the visuality and not the narrative aspects. In their words, the [Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=102&annotation=undefined)“[mediated] space […] is thus intelligible or not (rather than simulated or not, diegetic or not, or fictional or simulated (Aarseth, 2007)) because of its communicative nature” ([Arsenault et al., 2015, p. 102](zotero://select/library/items/AQQ93PWV))
...
[Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=102&annotation=SSYPZDM2)“Facing any image, we ask the question: how can the image itself demonstrate to a player the range of possible actions that she is allowed to do? The question of evaluating the efficiency of particular narrative strategies that aim to produce a diegetic world is not the focus here. This is a key choice since our framework needs to also cover games that don’t project a fictional world, such as the famous example of Tetris in game studies’ earliest controversies.” ([Arsenault et al., 2015, p. 102](zotero://select/library/items/AQQ93PWV))

A major aspect of the FAVR are visual modes, iE Super Marios Bros 3 title screen, message screen and gameplay screens. These [Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=103&annotation=undefined)“are created by the analyst for the purpose of discussing and analyzing games” ([Arsenault et al., 2015, p. 103](zotero://select/library/items/AQQ93PWV))
...
Anchor and mobility of the frame are two elements of the regimental aspects of graphical regimes. [Go to annotation](zotero://open-pdf/library/items/HVNIMWLW?page=111&annotation=undefined)“they are the descriptors of the kinetic qualities of the game’s graphics in relation to player control.” ([Arsenault et al., 2015, p. 111](zotero://select/library/items/AQQ93PWV))
...
%% Import Date: 2023-02-17T10:41:30.306+01:00 %%
